...
import com.gurkanmutlu.artbook.databinding.RecycleRowBinding

class ArtAdapter(val artList: ArrayList<art>) : RecyclerView.Adapter<ArtAdapter.ArtHolder>() {

    class ArtHolder(val binding: RecycleRowBinding) : RecyclerView.ViewHolder(binding.root) { //görünüm istediği için binding.root ekliyoruz
    ...
    // bağlanınca ne olacağını gösteriyoruz(Texti bağlıyoruz)
